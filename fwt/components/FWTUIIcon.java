...
/** An icon component that displays an FWT UI image. */
public class FWTUIIcon extends FWTComponent
{
	...
	/** Image ID for this icon (if any).  Null is disabled. */
	protected String iconTexture;
	/** Returns the texture for this icon (if any).  Null is disabled. */
	public String getTextureIcon() {return iconTexture;}
	/** Sets the texture for this icon. Set to 'null' to disable. */
	...
	public FWTUIIcon(XMLDataPacket data)
		{
			super(data);
		}
	
	/** Creates a new blank FWTIcon with the given XML target. */
	public FWTUIIcon(String parent, String object)
		{
			super(parent,object);
		}
	...
	protected XMLDataPacket getDefaultPropertiesByFile()
		{
			return super.getDefaultPropertiesByFile().merge(FWTController.getDefaultComponentProperties("icon"));
		}
	...
	public void drawIcon(SpriteBatch spriteBatch, ShapeRenderer shapeRenderer)
		{
			spriteBatch.begin();
			UIRenderer.drawUIImage(spriteBatch, id, iconTexture, 0, 0, (int)dims.width, (int)dims.height, scaleTexture, tileTexture);
			spriteBatch.end();
		}
